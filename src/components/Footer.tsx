            ...
            <div className="container">
                <div className="cta-box">
                    <div className="cta-content-box slide-up">
                        ...
                        <div className="spacer _40"></div><a href="/contact" className="button w-inline-block">
                ...
                <div className="container">
                    <div className="footer-box fade-in">
                        ...
                        <div className="footer-top">
                            <div className="logo-newsletter-box"><a href="/" aria-current="page"
                                className="brand footer w-nav-brand w--current"><img loading="lazy"
                                    src="images/logo.JPG" width={100} height={100} alt="" className="logo-image" /></a>
                            ...
                            <div className="footer-links-box">
                                <div className="footer-links-column"><a href="/about" className="footer-link">About us</a><a href="/services"
                                    className="footer-link">Services</a><a href="/projects" className="footer-link">Projects</a><a href="/blog"
                                        className="footer-link">Articles</a><a href="/contact" className="footer-link">Contact</a></div>
                                <div className="footer-links-column"><a href="/template/styleguide" className="footer-link">Styleguide</a><a
                                    href="/template/licenses" className="footer-link">Licenses</a><a href="/template/instruction"
                                        className="footer-link">Instruction</a><a href="https://modera-template.webflow.io/404" target="_blank"
                                            className="footer-link">404</a><a href="https://webflow.com/" target="_blank"
                                                className="footer-link">Webflow</a></div>
                            </div>
                            <div className="footer-contact-box">
                                <div className="footer-contact-links-box"><a href="mailto:sales@astonemetalarc.com"
                                    className="footer-contact-link">sales@astonemetalarc.com</a><a href="tel:+918744815500"
                                        className="footer-contact-link">+91 874 481 5500</a>
                                ...
                                <div className="footer-social-links-box"><a href="#" target="_blank"
                                ...
                                </a><a href="#" target="_blank" className="footer-social-link w-inline-block">
                                    ...
                                    </a><a href="https://www.linkedin.com/" target="_blank" className="footer-social-link w-inline-block">
